    ...
    <div class="container">
      ...
      <div class="row trending-box">
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 adv">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/logoml.png" alt=""></a>
              <span class="price">Rp51.800</span>
            </div>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 str">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/logoml.png" alt=""></a>
              <span class="price">Rp76.000</span>
            </div>
            <div class="down-content">
              <span class="category">DIAMONDS</span>
              <h4>275 Diamonds</h4>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 adv rac">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/logoml.png" alt=""></a>
              <span class="price">Rp94.800</span>
            </div>
            <div class="down-content">
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 str">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/logoml.png" alt=""></a>
              <span class="price">Rp132.000</span>
            </div>
            <div class="down-content">
              <span class="category">VALORANT POINTS</span>
              <h4>450 Diamonds</h4>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 rac str">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/logoml.png" alt=""></a>
              <span class="price">Rp153.000</span>
            </div>
            <div class="down-content">
              <span class="category">VALORANT POINTS</span>
              <h4>570 Diamonds</h4>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 rac adv">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/logoml.png" alt=""></a>
              <span class="price">Rp166.000</span>
            </div>
            <div class="down-content">
              <span class="category">VALORANT POINTS</span>
              <h4>610 Diamonds</h4>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 rac str">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/logoml.png" alt=""></a>
              <span class="price">Rp204.100</span>
            </div>
            <div class="down-content">
              <span class="category">VALORANT POINTS</span>
              <h4>758 Diamonds</h4>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 rac adv">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/logoml.png" alt=""></a>
              <span class="price">Rp387.000</span>
            </div>
            <div class="down-content">
              <span class="category">VALORANT POINTS</span>
              <h4>1500 Diamonds</h4>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 adv rac">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/logoml.png" alt=""></a>
              <span class="price">Rp546.000</span>
            </div>
            <div class="down-content">
              <span class="category">VALORANT POINTS</span>
              <h4>2200 Diamonds</h4>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 str">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/logoml.png" alt=""></a>
              <span class="price">Rp880.000</span>
            </div>
            <div class="down-content">
              <span class="category">VALORANT POINTS</span>
              <h4>3409 Diamonds</h4>
